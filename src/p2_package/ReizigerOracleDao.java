...
public class ReizigerOracleDao extends OracleBaseDao implements ReizigerDaoImpl {
	...
	public Reiziger save(Reiziger r) {
		...
		try {
			String sql = "insert into reiziger(voorletters,tussenvoegsel,achternaam,gebortedatum) \n"
					+ "values(?,?,?,?)";
			PreparedStatement stmnt = conn.prepareStatement(sql);
